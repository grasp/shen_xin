...
database_name = case Padrino.env
  when :development then 'shen_xin_development'
  when :production  then 'shen_xin_production'
  when :test        then 'shen_xin_test'
end
...
#     sessions:
#       default:
#         database: shen_xin_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: shen_xin_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: shen_xin_test
#         hosts:
#           - localhost:27017
#
#
